...
export default function MorningDewPage() {
  ...
  // Product data for Morning Dew
  const product = {
    id: 'morning-dew',
    name: 'Resin',
    basePrice: 82,
    image: '/product4.jpg', // Update this if the image is different in your data
    description: `A refreshing and uplifting fragrance inspired by the crispness of early morning air. Morning Dew blends dewy florals, green notes, and a touch of citrus for a scent that awakens the senses and energizes your day.`,
    notes: {
      top: 'Citrus, Green Leaves',
      heart: 'Dewy Florals, Jasmine',
