...
export default function PimentoPage() {
  ...
  // Product data for Pimento
  const product = {
    id: 'pimento',
    name: 'Pimento',
    basePrice: 65,
    image: '/product2.jpg', // Update this if the image is different in your data
    description: `A spicy and vibrant fragrance with a unique blend of pimento and warm spices. Perfect for those who love a bold, energetic scent that stands out in any crowd.`,
    notes: {
      top: 'Pimento, Citrus',
      heart: 'Spices, Floral',
      base: 'Woody, Musk',
