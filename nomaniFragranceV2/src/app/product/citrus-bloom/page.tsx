...
export default function CitrusBloomPage() {
  const { addToCart } = useCart();
  const [loading, setLoading] = useState(false);
  const country = useCountry();

  // Product data for Citrus Bloom
  const product = {
    id: 'citrus-bloom',
    name: 'Citrus Bloom',
    basePrice: 70,
    image: '/product3.jpg', // Update this if the image is different in your data
    description: `A bright and cheerful fragrance, Citrus Bloom combines sparkling citrus, fresh florals, and a hint of green notes for a scent that is uplifting and energizing.`,
    notes: {
      top: 'Lemon, Orange Blossom',
      heart: 'Jasmine, Neroli',
      base: 'Green Notes, Musk',
    },
    sizes: [
