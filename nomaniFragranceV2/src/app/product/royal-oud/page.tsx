...
export default function RoyalOudPage() {
  ...
  // Product data for Royal Oud
  const product = {
    id: 'royal-oud',
    name: 'Royal Oud',
    basePrice: 120,
    image: '/product1.jpg', // Update this if the image is different in your data
    description: `A regal and sophisticated fragrance, Royal Oud features precious oud wood, warm spices, and a touch of rose for a scent that is both powerful and refined.`,
    notes: {
      top: 'Rose, Saffron',
      heart: 'Oud, Spices',
