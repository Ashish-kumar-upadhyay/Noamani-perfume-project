...
export default function AmberMuskPage() {
  const { addToCart } = useCart();
  const [loading, setLoading] = useState(false);
  const country = useCountry();

  // Product data for Amber Musk
  const product = {
    id: 'amber-musk',
    name: 'Amber Musk',
    basePrice: 88,
    image: '/product2.jpg', // Update this if the image is different in your data
    description: `A warm and sensual fragrance, Amber Musk combines golden amber, creamy musk, and a hint of vanilla for a scent that is both comforting and alluring.`,
    notes: {
      top: 'Amber, Bergamot',
      heart: 'Musk, Vanilla',
