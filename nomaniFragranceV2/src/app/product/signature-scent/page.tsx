...
export default function RoseSaffronPage() {
  ...
  const product = {
    ...
    description: `Experience the opulence of Rose Saffron, a luxurious fragrance that blends the delicate essence of blooming roses with the exotic warmth of saffron. This signature scent opens with a burst of fresh petals, followed by a heart of golden saffron and subtle hints of amber. Perfect for those who appreciate elegance and sophistication, Rose Saffron lingers beautifully on the skin, leaving a memorable trail wherever you go.`,
    notes: {
      top: 'Rose Petals, Bergamot',
      heart: 'Saffron, Jasmine',
