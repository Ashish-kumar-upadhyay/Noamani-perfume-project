...
export default function OceanBreezePage() {
  ...
  // Product data for Ocean Breeze
  const product = {
    id: 'ocean-breeze',
    name: 'Ocean Breeze',
    basePrice: 82,
    image: '/product4.jpg', // Update this if the image is different in your data
    description: `A cool and invigorating fragrance inspired by the freshness of the ocean. Ocean Breeze combines aquatic notes, crisp citrus, and a hint of musk for a scent that is both refreshing and energizing, perfect for any occasion.`,
    notes: {
      top: 'Aquatic Notes, Citrus',
      heart: 'Sea Breeze, Jasmine',
      base: 'Musk, Driftwood',
    },
    sizes: [
